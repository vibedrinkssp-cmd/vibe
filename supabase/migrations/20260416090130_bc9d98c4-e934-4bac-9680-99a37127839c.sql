...
-- Drop and recreate get_current_cash_balance with correct signature
...
BEGIN
  ...
  RETURN QUERY SELECT
    ...
    v_saques,
    0::NUMERIC,
    (v_session.opening_balance + v_cash_sales + COALESCE(v_session.cash_supplies, 0) - v_sangrias - v_saques);
END;
$$;
