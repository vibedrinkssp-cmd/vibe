...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 left-1/2 -translate-x-1/2 z-[9999] flex max-h-screen w-full max-w-md flex-col gap-2 p-4",
      className
    )}
    {...props}
  />
